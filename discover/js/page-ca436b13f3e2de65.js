...
function S(){let{userImages:e,userName:t,premiumShown:s,setPremiumShown:m}=(0,p.a)(),{profiles:j}=(0,g.n)(),{toast:N}=(0,b.pm)(),[w,E]=(0,r.useState)(0),[Q,S]=(0,r.useState)(!1),[k,_]=(0,r.useState)("none"),[I,M]=(0,r.useState)(!1),[T,C]=(0,r.useState)(!1),[O,R]=(0,r.useState)([]),[Z,D]=(0,r.useState)(j),[P,z]=(0,r.useState)(!1),[J,U]=(0,r.useState)(100),[F,L]=(0,r.useState)(!1),[K,q]=(0,r.useState)(!1),[V,H]=(0,r.useState)([]),[W,Y]=(0,r.useState)(0),[G,X]=(0,r.useState)(null),[$,ee]=(0,r.useState)(0),[et,es]=(0,r.useState)(!1),[ea,er]=(0,r.useState)("heart"),[el,en]=(0,r.useState)(!1),ei=(0,r.useRef)(null),eo=localStorage.getItem("leadImage")||null,leadName=localStorage.getItem("leadName")||"Usuário";
...
(0,r.useEffect)(()=>{
    if("right"===k||"left"===k){
        let e=setTimeout(()=>{
            if("right"===k){
                if(!K){
                    let e=Math.round(100*(50+30*Math.random()))/100;
                    ee(e),z(!0);
                    let t=J+e;
